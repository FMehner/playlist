...
public class PlaylistMain {
    //Erstellt 5 Testsongs
    private static void addExampleSongs(Playlist playlist) {
        Song s1 = new Song("Blinding Lights", "The Weeknd", 200, Genre.POP);
        Song s2 = new Song("Afterworkrapper", "Pöbel MC", 159, Genre.POP);
        Song s3 = new Song("TODO ROTO - CRRDR REMIX", "Nathy Peluso", 176, Genre.ELECTRONIC);
        Song s4 = new Song("Ce geste absent (Version acoustique", "Dominique A", 309, Genre.CLASSICAL);
        Song s5 = new Song("Pulse", "James Malikey", 221, Genre.CLASSICAL);
    ...
    */
    ...
    private static Genre readGenre(Scanner scanner) {
     ...
     /* Wo soll printPlaylist() getestet werden?
